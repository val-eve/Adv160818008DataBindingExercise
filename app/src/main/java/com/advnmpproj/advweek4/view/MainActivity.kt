...
import com.advnmpproj.advweek4.util.createNotificationChannel
...
class MainActivity : AppCompatActivity() {
    ...
    companion object{
        ...
        fun showNotification(title:String, content:String, icon:Int){
            ...
            val notification = NotificationManagerCompat.from(instance!!.applicationContext)
            notification.notify(1001, builder.build())
        }
    }
